...
with open("./day026/file01.txt", "r") as file:
    file01 = file.read().splitlines()
data01 = [int(num) for num in file01]
print(data01)

with open("./day026/file02.txt", "r") as file:
    file02 = file.read().splitlines()
data02 = [int(num) for num in file02]
print(data02)
...
result = [num for num in data01 if num in data02]
